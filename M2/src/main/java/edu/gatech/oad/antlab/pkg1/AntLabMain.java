...
<<<<<<< HEAD
          ...
          Person1 p1 = new Person1("Jayden Sun");
          toPrint += p1.toString("qsun46");
          //Person2 replace P2 with your name
          //and gburdell with your gt id
          Person2 p2 = new Person2("Yebo Zhai");
          toPrint += p2.toString("yzhai8");
          //Person3 replace P3 with your name
          //and gburdell3 with your gt id
          Person3 p3 = new Person3("Zijia Ye");
          toPrint += p3.toString("zye46");
=======
		  //Person1 replace P1 with your name
		  //and gburdell1 with your gt id
		  Person1 p1 = new Person1("Jayden Sun");
...
>>>>>>> f5384a714ec8a702ec0095edf1864aa16dbcf2b7
                  //Person4 replace P4 with your name
                  //and gburdell4 with your gt id
                  Person4 p4 = new Person4("Mike Mallow");
                  toPrint += p4.toString("gmallow3");
                  //Person5 replace P4 with your name
                  //and gburdell5 with your gt id
                  Person5 p5 = new Person5("Yili Hui");
                  toPrint += p5.toString("yhui30");
