...
public class AddSourceReportActivity extends AppCompatActivity {
    ...
    public static List legalWaterType = Arrays.asList("Bottled", "Well", "Stream", "Lake", "Spring", "Other");
    public static List legalWaterCondition = Arrays.asList("Waste", "Treatable-Clear", "Treatable-Muddy", "Potable");
